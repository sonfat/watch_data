...
def I_file(link_list):
    with open('F:\GitHub\watch_data\\alg_compare\cache\cache1.txt','w') as f:
        try:
...
def collect_inner_text(page_no):
    ...
    with open('F:\GitHub\watch_data\\alg_compare\cache\cache1.txt', 'r') as f:
        for line in f:
            try:
...
def inner_in_file(inner_list, page_no):
    ...
    with open('F:\GitHub\watch_data\\alg_compare\load_text\\'+file_name, "w") as f:
        f.truncate()
